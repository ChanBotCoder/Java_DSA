...
public class MinHeap{
  ...
  private void bubbleUp(){
    ...
    int swapCount = 0;
    while (current > 1 && this.heap.get(current) < this.get(this.getParent(current))){
  ...
  public int getParent(int currnet){
    return (int) Math.floor(currnt / 2);
  }
  ...
  private void heapify(){
    ...
    if(this.size == 9999){
      System.out.println("A help of " + this.size + " elements was restored with only " + swapCount + " swaps!");
    }  
  }
